...
Console.WriteLine($"PASS: {assertions} assertions ({healthAssertions} sustained playback health, {recoveryAssertions} automatic recovery, {truthAssertions} playback truth)");
return 0;
}
catch (Exception ex)
{
